...
namespace PowerFx.Dataverse.Cdp.Tests
{
    public class CdpTests
    {
        ...
        public async Task Cdp_Sql()
        {
            ...
            Assert.Equal(@" x-ms-request-url: /apim/sql/2cc03a388d38465fba53f05cd2c76181/v2/datasets/default%2Cdefault/tables/%5BSalesLT%5D.%5BProduct%5D/items?api-version=2015-09-01&$filter=ProductID+eq+680&$top=1", query);
        }
        ...
        public async Task Cdp_Sql_NonSortable()
        {
            ...
            Assert.Equal<object>(@" x-ms-request-url: /apim/sql/2cc03a388d38465fba53f05cd2c76181/v2/datasets/default%2Cdefault/tables/%5BSalesLT%5D.%5BProduct%5D/items?api-version=2015-09-01&$filter=ProductID+eq+680&$top=1000", query);
        }
