...
namespace Microsoft.PowerFx.Dataverse
{
    ...
    internal class SqlCompileException : Exception
    {
        ...
        /// </summary>
        internal static readonly ErrorResourceKey FunctionSupportDisabled = DataverseStringResources.New("FormulaColumns_FunctionSupportDisabled");
        ...
        /// </summary>
        internal static readonly ErrorResourceKey DirectCurrencyNotSupported = DataverseStringResources.New("FormulaColumns_DirectCurrencyNotSupported");

        /// <summary>
        /// The error resource key for a formula column that uses OptionSet from related entity.
        /// </summary>
        internal static readonly ErrorResourceKey RelatedEntityOptionSetNotSupported = DataverseStringResources.New("FormulaColumns_RelatedEntityOptionSetNotSupported");

        /// <summary>
        /// The error resource key for a formula when optionset info for an optionsetName is not found.
        /// </summary>
        internal static readonly ErrorResourceKey InvalidOptionSet = DataverseStringResources.New("FormulaColumns_InvalidOptionSet");

        /// <summary>
        /// The error resource key for a formula when multiple optionsets are used as result.
        /// </summary>
        internal static readonly ErrorResourceKey ResultFromMultipleOptionSetsNotSupported = DataverseStringResources.New("FormulaColumns_ResultFromMultipleOptionSetsNotSupported");

        internal SqlCompileException(ErrorResourceKey key, Span context, params object[] args) 
            : base()
        {
