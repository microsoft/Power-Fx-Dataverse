    ...
    internal static partial class Library
    {
        ...
        private static Dictionary<TexlFunction, FunctionPtr> _funcsByName = new Dictionary<TexlFunction, FunctionPtr>
        {
         ...
         //   { BuiltinFunctionsCore.Ln, Ln },
            ...
            { BuiltinFunctionsCore.Max, (SqlVisitor runner, CallNode node, Context context) => MathScalarSetFunction(runner, node, context, "MAX", zeroNulls:false) },
            { BuiltinFunctionsCore.Mid, Mid },
            { BuiltinFunctionsCore.Min, (SqlVisitor runner, CallNode node, Context context) => MathScalarSetFunction(runner, node, context, "MIN", zeroNulls:false) },
