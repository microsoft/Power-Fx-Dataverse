    ...
    internal partial class DelegationIRVisitor : RewritingIRVisitor<DelegationIRVisitor.RetVal, DelegationIRVisitor.Context>
    {
        private RetVal ProcessLookUp(CallNode node, RetVal tableArg, Context context)
        {
            ...
            if (IsTableArgLookUpDelegable(context, tableArg))
            {
                ...
                result = new RetVal(_hooks, context, node, tableArg._sourceTableIRNode, tableArg.TableType, filterCombined, orderBy: orderBy, count: null, _maxRows, tableArg.ColumnMap);
            }
            else
            {
