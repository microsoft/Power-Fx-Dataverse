...
#pragma warning disable CS0618 // Type or member is obsolete
                        var rows = await t2.RetrieveMultipleAsync(new DataverseDelegationParameters() { Filter = filter, Top = 1, _columnSet = columns }, cancellationToken).ConfigureAwait(false);
