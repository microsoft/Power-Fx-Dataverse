...
";
        ...
        [InlineData("Substitute(\"abc\", guid, \"\", 1)", false, "Error 18-22: This argument cannot be passed as type Guid in formula columns.")] // "Coerce date to number in Substitute function"
