...
";
        ...
        [DataRow("Text(123)", false, "Error 0-9: Include a format in the second argument when using the Text function with numbers. The format string cannot include a thousands or decimal separator in formula columns.", DisplayName = "Text() function with single numeric arg is not supported")]
        [DataRow("Text(123.4)", false, "Error 0-11: Include a format in the second argument when using the Text function with numbers. The format string cannot include a thousands or decimal separator in formula columns.", DisplayName = "Text() function with single numeric arg is not supported")]
        [DataRow("Text(1/2)", false, "Error 0-9: Include a format in the second argument when using the Text function with numbers. The format string cannot include a thousands or decimal separator in formula columns.", DisplayName = "Text() function with single numeric arg is not supported")]
        [DataRow("Text(-123.4)", false, "Error 0-12: Include a format in the second argument when using the Text function with numbers. The format string cannot include a thousands or decimal separator in formula columns.", DisplayName = "Text() function with single numeric arg is not supported")]
        [DataRow("Text(1234567.89)", false, "Error 0-16: Include a format in the second argument when using the Text function with numbers. The format string cannot include a thousands or decimal separator in formula columns.", DisplayName = "Text() function with single numeric arg is not supported")]
        [DataRow("Text(If(1<0,2))", false, "Error 0-15: Include a format in the second argument when using the Text function with numbers. The format string cannot include a thousands or decimal separator in formula columns.", DisplayName = "Text() function with single numeric arg is not supported")]
        [DataRow("123 & 456", false, "Error 0-3: Use the Text function to convert numbers to text. Include a format in the second argument, which cannot include a thousands or decimal separator in formula columns.", DisplayName = "Implicit Conversion of Numbers is not supported")]
        [DataRow("123.45 & 456", false, "Error 0-6: Use the Text function to convert numbers to text. Include a format in the second argument, which cannot include a thousands or decimal separator in formula columns.", DisplayName = "Implicit Conversion of Numbers is not supported")]
        [DataRow("Concatenate(123, 456)", false, "Error 12-15: Use the Text function to convert numbers to text. Include a format in the second argument, which cannot include a thousands or decimal separator in formula columns.", DisplayName = "Implicit Conversion of Numbers is not supported")]
        [DataRow("123 & \"a\"", false, "Error 0-3: Use the Text function to convert numbers to text. Include a format in the second argument, which cannot include a thousands or decimal separator in formula columns.", DisplayName = "Implicit Conversion of Numbers is not supported")]
