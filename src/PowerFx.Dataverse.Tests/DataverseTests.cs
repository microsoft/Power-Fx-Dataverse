...
";
        ...
        [DataRow("Text(123.4)", false, "Error 5-10: The value argument is not supported for the Text function in formula columns.", DisplayName = "Non-literal arg string")]
        [DataRow("Text(1/2)", false, "Error 6-7: The value argument is not supported for the Text function in formula columns.", DisplayName = "Non-literal arg string")]
        [DataRow("Text(-123.4)", false, "Error 5-6: The value argument is not supported for the Text function in formula columns.", DisplayName = "Non-literal arg string")]
        [DataRow("Text(1234567.89)", false, "Error 5-15: The value argument is not supported for the Text function in formula columns.", DisplayName = "Non-literal arg string")]
        [DataRow("Text(If(1<0,2))", false, "Error 5-14: The value argument is not supported for the Text function in formula columns.", DisplayName = "Non-literal arg string")]
