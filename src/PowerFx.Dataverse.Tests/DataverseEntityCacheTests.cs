...
namespace Microsoft.PowerFx.Dataverse.Tests
{
    public class DataverseEntityCacheTests
    {
        ...
        public async Task EntityCache_CacheAPIs()
        {
            ...
            DataverseResponse<Entity> r2 = await cache.RetrieveAsync(entities[0].LogicalName, entities[0].Id, columnMap: null);
            Assert.NotNull(r2);
            ...
            DataverseResponse<Entity> r3 = await cache.RetrieveAsync(entities[0].LogicalName, entities[0].Id, columnMap: null);
            Assert.NotNull(r3);
