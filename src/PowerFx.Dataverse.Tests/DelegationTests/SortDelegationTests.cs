...
namespace Microsoft.PowerFx.Dataverse.Tests.DelegationTests
{
    public partial class DelegationTests
    {
        ...
        [InlineData(6, "FirstN(Sort(t1, Price), 2)", 2, "0003, 0001", false)]

        // Non-delegable
        [InlineData(7, "Sort(FirstN(t1, 1), Price)", 1, "0001", false)]
        [InlineData(8, "First(Sort(t1, Price))", 1, "0001", false)]
        ...
        [InlineData(13, "FirstN(SortByColumns(t1, Price), 2)", 2, "0003, 0001", false)]

        // Non-delegable
        [InlineData(14, "SortByColumns(FirstN(t1, 1), Price)", 1, "0001", false)]
        [InlineData(15, "First(SortByColumns(t1, Price))", 1, "0001", false)]
        ...
        // Delegable fully
        [InlineData(21, "FirstN(Sort(Filter(t1, Price <= 100), Quantity), 2)", 2, "0003, 0001", false)]
        [InlineData(22, "FirstN(Filter(Sort(t1, Quantity), Price <= 100), 2)", 2, "0003, 0001", false)]
        ...
        [InlineData(31, "LookUp(Sort(t1, Quantity), Price <= 100)", 1, "0001", false)]
