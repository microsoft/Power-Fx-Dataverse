...
namespace Microsoft.PowerFx.Dataverse.Tests.DelegationTests
{
    public class WithDelegationTests : DelegationTests
    {
        ...
        {
            await DelegationTestAsync(id, "WithDelegation.txt", expr, expectedRows, null, null, cdsNumberIsFloat, parserNumberIsFloatOption, null, false, true, expectedWarnings);
        }
    }
}
