...
namespace Microsoft.PowerFx.Dataverse.Tests.DelegationTests
{
    public partial class DelegationTests
    {
        ...
        [InlineData(275, "Filter(Summarize(t1, new_name, Sum(ThisGroup, Price) As TotalPrice), new_name = \"test\")", 0, false, false, "Warning 17-19: This operation on table 'local' may not work if it has more than 999 rows.")]
