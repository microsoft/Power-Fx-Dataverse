...
namespace Microsoft.PowerFx.Dataverse.Tests.DelegationTests
{
    public partial class DelegationTests
    {
        ...
        [InlineData(133, "Filter(t1, Rating <> 'Rating (Locals) (rating_optionSet)'.Hot)", 1, false, false)]
        [InlineData(134, "Filter(t1, Rating <> 'Rating (Locals) (rating_optionSet)'.Hot)", 1, true, true)]
        [InlineData(135, "Filter(t1, Rating <> 'Rating (Locals) (rating_optionSet)'.Hot)", 1, true, false)]
        [InlineData(136, "Filter(t1, Rating <> 'Rating (Locals) (rating_optionSet)'.Hot)", 1, false, true)]
        [InlineData(137, "Filter(t1, Rating = 'Rating (Locals) (rating_optionSet)'.Hot)", 2, false, false)]
        [InlineData(138, "Filter(t1, Rating = 'Rating (Locals) (rating_optionSet)'.Hot)", 2, true, true)]
        [InlineData(139, "Filter(t1, Rating = 'Rating (Locals) (rating_optionSet)'.Hot)", 2, true, false)]
        [InlineData(140, "Filter(t1, Rating = 'Rating (Locals) (rating_optionSet)'.Hot)", 2, false, true)]
        ...
        [InlineData(190, "Filter(t1, State = 'State (Locals) (new_state_optionSet)'.Active)", 1, true, true)]
        [InlineData(191, "Filter(t1, State = 'State (Locals) (new_state_optionSet)'.Active)", 1, false, false)]
        [InlineData(192, "Filter(t1, State = 'State (Locals) (new_state_optionSet)'.Active)", 1, true, false)]
        [InlineData(193, "Filter(t1, State = 'State (Locals) (new_state_optionSet)'.Active)", 1, false, true)]
        [InlineData(194, "Filter(t1, State = If(1<0, 'State (Locals) (new_state_optionSet)'.Active))", 0, true, true)]
        [InlineData(195, "Filter(t1, State = If(1<0, 'State (Locals) (new_state_optionSet)'.Active))", 0, false, false)]
        [InlineData(196, "Filter(t1, State = If(1<0, 'State (Locals) (new_state_optionSet)'.Active))", 0, true, false)]
        [InlineData(197, "Filter(t1, State = If(1<0, 'State (Locals) (new_state_optionSet)'.Active))", 0, false, true)]
        ...
        public void Delegation_DateTest()
        {
            ...
            Assert.Equal<object>("__retrieveMultiple(MyTable, __lt(MyTable, {fieldFunctions:Table(), fieldName:Date}, DateAdd(Now(), Float(30), (TimeUnit).Days)), __noop(), 1000, __noopGroupBy(), )", actualIr);
        }
    }
}
