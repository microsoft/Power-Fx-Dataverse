...
namespace Microsoft.PowerFx.Dataverse.Tests.DelegationTests
{
    public partial class DelegationTests
    {
        ...
        [InlineData(247, "LookUp(Summarize(t1, new_name, Sum(ThisGroup, Price) As TotalPrice), new_name = \"test\")", null, false, false, "Warning 17-19: This operation on table 'local' may not work if it has more than 999 rows.")]
