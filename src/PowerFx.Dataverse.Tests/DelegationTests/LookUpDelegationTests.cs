...
namespace Microsoft.PowerFx.Dataverse.Tests.DelegationTests
{
    public partial class DelegationTests
    {
        ...
        [InlineData(168, "LookUp(t1, State = 'State (Locals) (new_state_optionSet)'.Active).Price", 100.0, true, true)]
        [InlineData(169, "LookUp(t1, State = 'State (Locals) (new_state_optionSet)'.Active).Price", 100.0, false, false)]
        [InlineData(170, "LookUp(t1, State = 'State (Locals) (new_state_optionSet)'.Active).Price", 100.0, true, false)]
        [InlineData(171, "LookUp(t1, State = 'State (Locals) (new_state_optionSet)'.Active).Price", 100.0, false, true)]
        [InlineData(172, "LookUp(t1, State = If(1<0, 'State (Locals) (new_state_optionSet)'.Active)).Price", null, true, true)]
        [InlineData(173, "LookUp(t1, State = If(1<0, 'State (Locals) (new_state_optionSet)'.Active)).Price", null, false, false)]
        [InlineData(174, "LookUp(t1, State = If(1<0, 'State (Locals) (new_state_optionSet)'.Active)).Price", null, true, false)]
        [InlineData(175, "LookUp(t1, State = If(1<0, 'State (Locals) (new_state_optionSet)'.Active)).Price", null, false, true)]
