...
namespace Microsoft.PowerFx.Dataverse.Tests.DelegationTests
{
    public partial class DelegationTests
    {
        ...
        [InlineData(182, "LookUp(t1, DateAdd(DateTime, -2) < DateTime)", null, true, true, "Warning 19-27: Can't delegate LookUp: Expression compares multiple fields.", "Warning 7-9: This operation on table 'local' may not work if it has more than 999 rows.")]
