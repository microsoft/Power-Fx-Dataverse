...
namespace Microsoft.PowerFx.Dataverse.Tests.DelegationTests
{
    public class ApiDelegationTests
    {
        ...
        [Theory]
        [InlineData("Filter(t1, Price < 120)", "__retrieveMultiple(t1, __lt(t1, {fieldFunctions:Table(), fieldName:Price}, Float(120)), __noop(), __noJoin(), __noopGroupBy(), 1000, __allColumns())")]
